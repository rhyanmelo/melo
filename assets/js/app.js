...
// Adicionando detecção de cópia
document.addEventListener('copy', function(event) {
    event.preventDefault(); // Impede a cópia
    alert('Cópia não autorizada!'); // Exibe mensagem de aviso
});

// Prevenção de exibição em iframes externos
if (window !== window.top) {
    window.top.location = window.location; // Redireciona para o próprio site
}